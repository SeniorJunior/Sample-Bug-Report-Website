...
class developerUpdateInboxController
{
	// Function updateDeveloperInbox to update the value of the assignee
	public function updateDeveloperInbox()
	{
		if (isset($_POST['submit'])) 
		{
	        $update_dev = new bugReport();
	        $update_dev->updateDeveloperInboxEntity();
		}
	}
}
