...
// Function updateReviewerInbox to update the value of the assignee

class reviewerUpdateInboxController
{
	// Function closeTriagerInbox to update the value of the assignee
	public function updateReviewerInbox()
	{
		if (isset($_POST['submit']))
		{
			$Update_report = new bugReport();
			$Update_report->updateReviewerInboxEntity();
		}
	}
}
